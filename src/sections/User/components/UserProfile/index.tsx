...
export const UserProfile = ({ user, viewerIsUser, viewer, setViewer, handleUserRefetch }: Props) => {
  ...
  const additionalDetails = user.hasWallet ? (
    ...
    <Fragment>
      <Paragraph>Interested in becoming a Bookeo host? Register with your Stripe account!</Paragraph>
      <Button type='primary' onClick={redirectToStripe} className='user-profile__details-cta'>
        Connect with Stripe!
      </Button>
      <Paragraph type='secondary'>
        Bookeo uses{' '}
